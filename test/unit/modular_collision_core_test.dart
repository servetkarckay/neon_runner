...
void main() {
  group('Modular Collision Core Tests', () {
    ...
    group('CollisionEngine Basic Tests', () {
      ...
      test('should detect grazing collisions', () {
        ...
        expect(grazingEvents.first.priority, equals(CollisionPriority.low));
      });
    });
    ...
    group('Collision Shape Tests', () {
      ...
      test('should correctly create and test circle shapes', () {
        // Arrange
        final rect1 = Rect.fromLTWH(0, 0, 50, 50);
        final circle1 = CircleShapeData(rect1, Vector2(25, 25), 20);
        final rect2 = Rect.fromLTWH(40, 15, 20, 20);
        final circle2 = CircleShapeData(rect2, Vector2(60, 25), 20); // Touching circles

        // Act & Assert
        expect(circle1.collidesWith(circle2), isTrue); // Touching/overlapping

        final rect3 = Rect.fromLTWH(100, 15, 20, 20);
        final circle3 = CircleShapeData(rect3, Vector2(110, 25), 20); // Far away
    ...
    group('Integration Tests', () {
      test('should handle complete collision detection cycle', () {
        // Arrange
